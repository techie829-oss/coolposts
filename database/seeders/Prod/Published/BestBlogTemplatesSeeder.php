    ...
    public function run(): void
    {
        ...
        BlogPost::updateOrCreate(
            ...
            [
                ...
                'meta_title' => 'Best Blog Post Templates for Tutorials & Reviews',
                'meta_description' => 'Write better content faster. Explore proven templates for tutorials, reviews, business pages, and portfolios that boost engagement.',
                'meta_keywords' => ['best blog templates', 'tutorial template', 'review template', 'business blog layout', 'portfolio content'],
                'canonical_url' => 'https://www.coolposts.site/blog-posts/best-blog-post-templates-tutorials-reviews-business',
                'status' => 'published',
