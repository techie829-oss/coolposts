<x-guest-layout>
    ...
    <x-slot name="head">
        <meta name="description"
            content="Sign in to your CoolPosts account to manage your links, track analytics, and access all features. Secure login for link monetization platform.">
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <div class="mt-12 grid grid-cols-3 gap-4 text-center">
                <div class="text-white">
                    <div
                        class="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center mx-auto mb-2">
                ...
                <div class="text-white">
                    <div
                        class="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mx-auto mb-2">
                ...
                <div class="text-white">
                    <div
                        class="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center mx-auto mb-2">
