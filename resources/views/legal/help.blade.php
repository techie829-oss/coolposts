            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        ...
                        <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg p-6 text-white">
                            ...
                            <a href="#account-settings"
                                class="inline-flex items-center text-yellow-100 hover:text-white">
                                Learn More
                                <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7"></path>
                        ...
                        <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg p-6 text-white">
                            ...
                            <a href="{{ route('docs.index') }}"
                                class="inline-flex items-center text-indigo-100 hover:text-white">
                                Learn More
                                <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7"></path>
                    ...
                    <div class="space-y-8">
                        ...
                        <div id="getting-started" class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-white rounded-lg p-6 shadow-sm">
                                    <h3 class="text-lg font-semibold text-gray-900 mb-3">Understanding Your Dashboard
                                    </h3>
                                    <p class="text-gray-600 mb-4">Your dashboard provides an overview of your link
                                    ...
                                    <ul class="list-disc list-inside space-y-2 text-gray-600">
                                        ...
                                        <li><strong>Total Earnings:</strong> Your accumulated earnings from monetized
                                            links</li>
                                        <li><strong>Pending Earnings:</strong> Earnings not yet available for withdrawal
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div id="monetization" class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="space-y-6">
                                <div class="bg-white rounded-lg p-6 shadow-sm">
                                    ...
                                    <p class="text-gray-600 mb-4">When you enable monetization on a link, visitors will
                                        see a brief advertisement before being redirected to your original URL. You earn
                                        money based on:</p>
                                    <ul class="list-disc list-inside space-y-2 text-gray-600">
                        ...
                        <div id="analytics" class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="space-y-6">
                                <div class="bg-white rounded-lg p-6 shadow-sm">
                                    <h3 class="text-lg font-semibold text-gray-900 mb-3">Understanding Your Analytics
                                    </h3>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <ul class="list-disc list-inside space-y-1 text-sm text-gray-600">
                                                ...
                                                <li><strong>Conversion Rate:</strong> Percentage of clicks that
                                                    completed monetization</li>
                                ...
                                <div class="bg-white rounded-lg p-6 shadow-sm">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">Enable 2FA for enhanced account security
                                                using authenticator apps or SMS.</p>
                                        </div>
                                        <div>
                                            <h4 class="font-medium text-gray-900 mb-2">Login History:</h4>
                                            <p class="text-sm text-gray-600">Monitor your account activity and detect
                                ...
                                <div class="bg-white rounded-lg p-6 shadow-sm">
                                    ...
                                    <div class="space-y-4">
                                        <div class="border-l-4 border-red-500 pl-4">
                                            ...
                                            <p class="text-sm text-gray-600 mt-1">Check if your original URL is still
                                                accessible. If the issue persists, contact support.</p>
                                        </div>

                                        <div class="border-l-4 border-yellow-500 pl-4">
                                            <h4 class="font-medium text-gray-900">Low Earnings</h4>
                                            <p class="text-sm text-gray-600 mt-1">Earnings depend on traffic quality
                                                and location. Focus on organic, high-quality traffic sources.</p>
                                        </div>

                                        <div class="border-l-4 border-blue-500 pl-4">
                                            <h4 class="font-medium text-gray-900">Analytics Not Updating</h4>
                                            <p class="text-sm text-gray-600 mt-1">Analytics update in real-time. If you
                                                don't see updates, try refreshing the page.</p>
                                        </div>

                                        <div class="border-l-4 border-green-500 pl-4">
                                            <h4 class="font-medium text-gray-900">Payment Issues</h4>
                                            <p class="text-sm text-gray-600 mt-1">Ensure your payment information is
                                                correct and you've reached the minimum withdrawal threshold.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-12 text-center bg-blue-50 rounded-lg p-8">
                        ...
                        <p class="text-gray-600 mb-6">Our support team is available 24/7 to assist you with any
