...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'monetization_type' => 'nullable|in:' . implode(',', array_keys(BlogPost::MONETIZATION_TYPES)),
            'earning_rate_less_2min' => 'nullable|numeric|min:0|max:1',
            'earning_rate_2_5min' => 'nullable|numeric|min:0|max:1',
            'earning_rate_more_5min' => 'nullable|numeric|min:0|max:1',
        ...
        if ($request->hasFile('featured_image')) {
            // Bypass local optimization (GD memory issues) - use Cloudinary SDK directly
