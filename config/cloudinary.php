...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Cloudinary Cloud Configuration (ADDED TO FIX PACKAGE BUG)
    |--------------------------------------------------------------------------
    |
    | The CloudinaryServiceProvider expects this 'cloud' key to exist.
    | This is missing from the official published config but required by the provider.
    |
    */
    'cloud' => [
